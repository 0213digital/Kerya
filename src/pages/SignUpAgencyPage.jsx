        ...
        <div className="container mx-auto max-w-md py-16 px-4">
            <form onSubmit={handleSignUp} className="bg-white p-8 rounded-lg shadow-md">
                ...
                <div className="space-y-4">
                    ...
                    <button type="submit" disabled={loading} className="w-full bg-sky-600 text-white py-2 rounded-md font-semibold hover:bg-sky-700 disabled:bg-sky-400">{loading ? t('loading') : t('signup')}</button>
                </div>
