...
import { PartyPopper, Download, Clock } from 'lucide-react';
...
export function BookingConfirmationPage({ generateInvoice }) {
    ...
    const isInstantBooking = booking.status === 'confirmed';
        ...
        <div className="container mx-auto max-w-2xl py-16 px-4 text-center">
            <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <h1 className="text-3xl font-bold mt-4">
                    {isInstantBooking ? t('bookingConfirmedTitle') : t('bookingRequestSent')}
                </h1>
                <p className="text-slate-500 mt-2 mb-8">
                    {isInstantBooking ? t('bookingConfirmedDesc') : t('bookingRequestSentDesc')}
                </p>
